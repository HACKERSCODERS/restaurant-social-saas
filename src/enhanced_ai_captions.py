...
class EnhancedAICaptionGenerator:
    """Enhanced AI caption generator for restaurant food photos using OpenAI Vision API"""
...
if __name__ == "__main__":
    ...
    generator = EnhancedAICaptionGenerator("your-openai-api-key")
    ...
    # Test fallback caption
    print("Fallback Caption:")
    print(generator._generate_fallback_caption(restaurant_context))
    print("\n" + "="*50 + "\n")
